...
osmium tags-filter --overwrite -o data/alaska-filtered.osm.pbf data/alaska-latest.osm.pbf \
  amenity=fuel,drinking_water,restaurant,cafe,fast_food,bar,pub,toilets,shower,bank,atm,hospital,clinic,pharmacy,post_office,ranger_station,shelter,parking,charging_station,bicycle_rental,motorcycle_rental,car_rental,boat_rental,ferry_terminal,community_centre,library,sanitary_dump_station \
